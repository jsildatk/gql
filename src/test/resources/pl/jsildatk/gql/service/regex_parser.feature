Feature: Parsing with regex operator (REGEX)
  ...
  Scenario: Parsing with developer field
    Given I am looking for a "developer" field with "REGEX" operator and "T*" value
  ...
  Scenario: Parsing with year field
    Given I am looking for a "year" field with "REGEX" operator and "201(1|3)" value
    When I am parsing query
    Then Result contains
      | title | publisher | developer | genre | year |
      | Test1 | Test      | Test 1    | Test  | 2011 |
